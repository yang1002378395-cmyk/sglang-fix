...
@maybe_wrap_jit_kernel_debug(op_name="jit_kernel.norm.fused_inplace_qknorm")
...
@maybe_wrap_jit_kernel_debug(op_name="jit_kernel.norm.rmsnorm")
def rmsnorm(
    input: torch.Tensor,
    weight: torch.Tensor,
...
@maybe_wrap_jit_kernel_debug(op_name="jit_kernel.norm.fused_add_rmsnorm")
